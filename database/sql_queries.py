...
READ_ALL_ID_USER_TABLE = """
SELECT * FROM telegram_users WHERE ID = ?
"""

READ_ALL_USER_TABLE_QUELY = """
...
UPDATE_SENDER_USER_BALANCE = """
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) - ? WHERE TELEGRAM_ID = ?
"""

UPDATE_RECIPIENT_USER_BALANCE = """
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) + ? WHERE TELEGRAM_ID = ?
"""

CREATE_DONATE_TRANSACTIONS_TABLE = """
...
INSERT_DONATE_TRANSACTIONS_TABLE = """
...
CREATE_SEND_MONEY_TRANSACTIONS_TABLE = """
CREATE TABLE IF NOT EXISTS send_money_transactions(
ID INTEGER PRIMARY KEY,
SENDER_TELEGRAM_ID INTEGER,
RECIPIENT_TELEGRAM_ID INTEGER,
AMOUNT INTEGER
...
INSERT_SEND_MONEY_TRANSACTIONS_TABLE = """
INSERT INTO send_money_transactions VALUES (?, ?, ?, ?)
"""

UPDATE_SENDER_ID_USER_BALANCE = """
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) - ? WHERE ID = ?
"""

UPDATE_RECIPIENT_ID_USER_BALANCE = """
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) + ? WHERE ID = ?
"""

READ_ALL_ID_USER_TABLE_SEND_MONEY = """
SELECT * FROM send_money_transactions WHERE ID = ?
"""

CREATE_DORAMS_TABLE = """
CREATE TABLE IF NOT EXISTS dorams(
ID INTEGER PRIMARY KEY,
LINK TEXT
)
"""
...
READ_DORAMS_TABLE = """
SELECT * FROM dorams WHERE LINK = ?
"""

INSERT_DORAM_TABLE = """
INSERT INTO dorams VALUES (?, ?)
"""